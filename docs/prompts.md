...
| [`create-github-pull-request-from-specification.prompt.md`](https://github.com/github/awesome-copilot/tree/main/skills/create-github-pull-request-from-specification) | 仕様から PR 作成 | GitHub Pull Request |
...
| [`my-issues.prompt.md`](https://github.com/github/awesome-copilot/tree/main/skills/my-issues) | 自分の Issue 一覧 | 担当 Issue リスト |
| [`my-pull-requests.prompt.md`](https://github.com/github/awesome-copilot/tree/main/skills/my-pull-requests) | 自分の PR 一覧 | 担当 PR リスト |
...
| [`model-recommendation.prompt.md`](https://github.com/github/awesome-copilot/tree/main/skills/model-recommendation) | モデル推奨 | AI モデル選択ガイド |
...
| [`suggest-awesome-github-copilot-collections.prompt.md`](https://github.com/github/awesome-copilot/tree/main/skills/suggest-awesome-github-copilot-collections) | おすすめ Collections 提案 | コレクション推奨 |
...
| [`suggest-awesome-github-copilot-prompts.prompt.md`](https://github.com/github/awesome-copilot/tree/main/skills/suggest-awesome-github-copilot-prompts) | おすすめ Prompts 提案 | プロンプト推奨 |
...
| [`prompt-builder.prompt.md`](https://github.com/github/awesome-copilot/tree/main/skills/prompt-builder) | プロンプトビルダー | カスタムプロンプト作成 |
...
| ファイル名 | 用途 | 出力 |
|-----------|------|------|
| [`create-oo-component-documentation.prompt.md`](https://github.com/github/awesome-copilot/tree/main/skills/create-oo-component-documentation) | OO コンポーネントドキュメント作成 | コンポーネントドキュメント |
| [`update-oo-component-documentation.prompt.md`](https://github.com/github/awesome-copilot/tree/main/skills/update-oo-component-documentation) | OO コンポーネントドキュメント更新 | 更新されたドキュメント |
