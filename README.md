...
- [このガイドについて](#このガイドについて)
- [カスタマイズの種類](#カスタマイズの種類)
- [Instructions - コーディング規約の自動適用](#instructions---コーディング規約の自動適用)
- [Prompts - 再利用可能なタスクテンプレート](#prompts---再利用可能なタスクテンプレート)
- [Agents - 専門家ペルソナ](#agents---専門家ペルソナ)
- [Skills - リソース同梱の複合ツール](#skills---リソース同梱の複合ツール)
- [Collections - カスタマイズのセット](#collections---カスタマイズのセット)
- [Hooks - セッションイベント駆動の自動アクション](#hooks---セッションイベント駆動の自動アクション)
- [Agentic Workflows - AI 駆動のリポジトリ自動化](#agentic-workflows---ai-駆動のリポジトリ自動化)
- [Cookbook Recipes - 実践的なコード例](#cookbook-recipes---実践的なコード例)
...
| カテゴリ | 主なルール例 | 活用場面 |
|---------|------------|---------|
| [**Python**](https://github.com/github/awesome-copilot/blob/main/instructions/python.instructions.md) | 型ヒント必須、docstring 形式、async/await パターン | Python プロジェクトの品質統一 |
| [**TypeScript**](https://github.com/github/awesome-copilot/blob/main/instructions/typescript-5-es2022.instructions.md) | strict モード、import 整理、エラーハンドリング | フロントエンド/バックエンド TypeScript 開発 |
| [**Java**](https://github.com/github/awesome-copilot/blob/main/instructions/java.instructions.md) | バージョン移行ガイド（11→17, 17→21, 21→25） | Java バージョンアップ対応 |
...
| カテゴリ | 主なルール例 | 活用場面 |
|---------|------------|---------|
| [**React**](https://github.com/github/awesome-copilot/blob/main/instructions/reactjs.instructions.md) | 関数コンポーネント、Hooks ベスト・プラクティス | React SPA 開発 |
| [**Vue.js**](https://github.com/github/awesome-copilot/blob/main/instructions/vuejs3.instructions.md) | Composition API、リアクティビティパターン | Vue アプリケーション開発 |
| [**Angular**](https://github.com/github/awesome-copilot/blob/main/instructions/angular.instructions.md) | モジュール構成、RxJS パターン | Angular エンタープライズ開発 |
...
| [**implementation-plan**](https://github.com/github/awesome-copilot/blob/main/agents/implementation-plan.agent.md) | 実装計画策定者 | 機能設計、タスク分解 |

#### 言語・フレームワーク専門家

| エージェント名 | 役割 | 活用場面 |
|--------------|------|---------|
| [**python-expert**](https://github.com/github/awesome-copilot/blob/main/agents/python-mcp-expert.agent.md) | Python 開発の専門家 | Python アプリ設計・最適化 |
| [**csharp-expert / dotnet-expert**](https://github.com/github/awesome-copilot/blob/main/agents/expert-dotnet-software-engineer.agent.md) | C#/.NET の専門家 | .NET アプリ設計・最適化 |
| [**java-expert**](https://github.com/github/awesome-copilot/blob/main/agents/java-mcp-expert.agent.md) | Java 開発の専門家 | Java エンタープライズ開発 |
| [**react-expert / nextjs-expert**](https://github.com/github/awesome-copilot/blob/main/agents/expert-react-frontend-engineer.agent.md) | React/Next.js の専門家 | フロントエンド設計 |
| [**rust-expert**](https://github.com/github/awesome-copilot/blob/main/agents/rust-mcp-expert.agent.md) | Rust 開発の専門家 | Rust システム開発 |
...
| エージェント名 | 役割 | 活用場面 |
|--------------|------|---------|
| [**postgresql-dba**](https://github.com/github/awesome-copilot/blob/main/agents/postgresql-dba.agent.md) | PostgreSQL DBA | DB 設計、クエリ最適化 |
| [**mongodb-expert**](https://github.com/github/awesome-copilot/blob/main/agents/mongodb-performance-advisor.agent.md) | MongoDB の専門家 | NoSQL データモデリング |
| [**mssql-dba**](https://github.com/github/awesome-copilot/blob/main/agents/ms-sql-dba.agent.md) | SQL Server DBA | SQL Server 管理・最適化 |
...
| エージェント名 | 役割 | 活用場面 |
|--------------|------|---------|
| [**Octopus Deploy**](https://github.com/github/awesome-copilot/blob/main/agents/octopus-deploy-release-notes-mcp.agent.md) | デプロイ自動化 | CD パイプラインの最適化 |
| [**LaunchDarkly**](https://github.com/github/awesome-copilot/blob/main/agents/launchdarkly-flag-cleanup.agent.md) | フィーチャーフラグ管理 | 段階的リリース |
| [**PagerDuty**](https://github.com/github/awesome-copilot/blob/main/agents/pagerduty-incident-responder.agent.md) | インシデント対応 | 障害対応の効率化 |
| [**Dynatrace**](https://github.com/github/awesome-copilot/blob/main/agents/dynatrace-expert.agent.md) | パフォーマンス監視 | APM 設定・分析 |
| [**JFrog**](https://github.com/github/awesome-copilot/blob/main/agents/jfrog-sec.agent.md) | セキュリティスキャン | 依存関係の脆弱性管理 |
...
Hooks は、GitHub Copilot コーディングエージェントのセッション中に発生する特定のイベント（セッション開始・終了、プロンプト送信、ツール実行前後など）をトリガーとして自動実行されるスクリプトです。`hooks.json` 設定ファイルとヘルパースクリプトをフォルダにまとめて配置します。

### こんなときに使える

- **セッションのログ・監査証跡を残したい** — セッション開始・終了・プロンプトを自動記録してコンプライアンスに対応
- **危険な操作を事前にブロックしたい** — 破壊的ファイル操作や force push などをエージェントが実行する前に遮断
- **依存関係のライセンスを自動チェックしたい** — セッション終了時に新規追加パッケージのライセンスを自動スキャン
- **シークレットの漏洩を防ぎたい** — セッション中に変更されたファイルを自動スキャンしてシークレット検出
- **セッション終了時に変更を自動コミットしたい** — コーディングエージェントの作業結果を自動でコミット＆プッシュ

### 利用できる主な Hooks

| フック名 | 概要 | 対応イベント |
|---------|------|------------|
| [**dependency-license-checker**](https://github.com/github/awesome-copilot/tree/main/hooks/dependency-license-checker) | 新規追加依存関係のライセンス（GPL、AGPL 等）コンプライアンスをチェック | sessionEnd |
| [**governance-audit**](https://github.com/github/awesome-copilot/tree/main/hooks/governance-audit) | Copilot エージェントのプロンプトをスキャンしてガバナンスイベントをログ記録 | sessionStart, sessionEnd, userPromptSubmitted |
| [**secrets-scanner**](https://github.com/github/awesome-copilot/tree/main/hooks/secrets-scanner) | セッション中に変更されたファイルをスキャンし、シークレット・認証情報・機密データを検出 | sessionEnd |
| [**session-auto-commit**](https://github.com/github/awesome-copilot/tree/main/hooks/session-auto-commit) | コーディングエージェントのセッション終了時に変更を自動コミット＆プッシュ | sessionEnd |
| [**session-logger**](https://github.com/github/awesome-copilot/tree/main/hooks/session-logger) | コーディングエージェントのセッション全アクティビティを監査・分析用にログ記録 | sessionStart, sessionEnd, userPromptSubmitted |
| [**tool-guardian**](https://github.com/github/awesome-copilot/tree/main/hooks/tool-guardian) | 危険なツール操作（破壊的ファイル操作、force push、DB DROP）を実行前にブロック | preToolUse |

### 設定方法

フック一式（`hooks.json` + スクリプト）をリポジトリの `.github/hooks/` ディレクトリに配置します。

```
.github/
  hooks/
    session-auto-commit/
      hooks.json          # フック設定（イベントとスクリプトのマッピング）
      auto-commit.sh      # 実行スクリプト
    secrets-scanner/
      hooks.json
      scan-secrets.sh
```
...
Agentic Workflows は、GitHub Actions 上でコーディングエージェントを実行する AI 駆動のリポジトリ自動化の仕組みです。自然言語の指示をフロントマター付きの Markdown ファイルで定義し、スケジュールやイベントを起点に自動実行できます。セキュリティファーストな設計とガードレールを備えています。

### こんなときに使える

- **Issue のトリアージ・ラベリングを自動化したい** — 新しい Issue を自動で分類し、適切なラベルを付与
- **定期的なステータスレポートを生成したい** — 毎日・毎週の進捗サマリーを自動作成して Issue に投稿
- **ドキュメントを常に最新に保ちたい** — コード変更に合わせて自動でドキュメントを更新
- **スラッシュコマンドで操作したい** — Issue や PR にコメントするだけでエージェントを呼び出せる
- **コード品質チェックを定期実行したい** — スケジュールに従って自動でコードレビューや品質検証を実施

### 利用できる主な Agentic Workflows

| ワークフロー名 | 概要 | トリガー |
|--------------|------|---------|
| [**daily-issues-report**](https://github.com/github/awesome-copilot/blob/main/workflows/daily-issues-report.md) | 未解決 Issue と最近のアクティビティの日次サマリーを Issue として投稿 | schedule |
| [**ospo-contributors-report**](https://github.com/github/awesome-copilot/blob/main/workflows/ospo-contributors-report.md) | 組織全体のコントリビューター活動状況の月次レポート | schedule, workflow_dispatch |
| [**ospo-org-health**](https://github.com/github/awesome-copilot/blob/main/workflows/ospo-org-health.md) | ステール Issue/PR・マージ時間・コントリビューターランキングなどを含む週次ヘルスレポート | schedule, workflow_dispatch |
| [**ospo-stale-repos**](https://github.com/github/awesome-copilot/blob/main/workflows/ospo-stale-repos.md) | 非アクティブなリポジトリを特定しアーカイブ候補レポートを生成 | schedule, workflow_dispatch |
| [**ospo-release-compliance-checker**](https://github.com/github/awesome-copilot/blob/main/workflows/ospo-release-compliance-checker.md) | OSS リリース要件に対するコンプライアンスチェックをレポートとして Issue に投稿 | issues, workflow_dispatch |
...
| [**relevance-summary**](https://github.com/github/awesome-copilot/blob/main/workflows/relevance-summary.md) | `/relevance-check` 回答済みの未解決 Issue/PR を1つの Issue にまとめてレポート | workflow_dispatch |

### 設定方法

`gh aw` CLI 拡張機能を使って導入します。

```bash
# gh aw 拡張機能をインストール
gh extension install github/gh-aw

# ワークフロー .md ファイルをリポジトリの .github/workflows/ に配置後、
# .lock.yml ファイルにコンパイル
gh aw compile
...
.github/
  workflows/
    daily-issues-report.md       # ワークフロー定義（自然言語 + フロントマター）
    daily-issues-report.lock.yml # コンパイル済み GitHub Actions ファイル
```
...
- [Agentic Workflows ドキュメント](https://github.com/github/awesome-copilot/blob/main/docs/README.workflows.md) — AI 駆動ワークフローの一覧と使い方
- [Hooks ドキュメント](https://github.com/github/awesome-copilot/blob/main/docs/README.hooks.md) — セッションイベント駆動フックの一覧と使い方
